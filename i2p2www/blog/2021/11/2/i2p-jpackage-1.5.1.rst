...
* Updates launcher script to `fix post NSIS launch issue on some architectures <https://i2pgit.org/I2P_Developers/i2p.firefox/-/issues/9>`_

For a full list of changes see the `changelog.txt in i2p.firefox <https://i2pgit.org/I2P_Developers/i2p.firefox/>`_
{%- endtrans %}
...
For a summary of development see the `checkins in i2p-jpackage-mac <https://i2pgit.org/I2P_Developers/i2p-jpackage-mac>`_
{%- endtrans %}
