...
There is a larger and more long-term goal of this event, and it is to build a commnutiy of privacy concious individuals. By connecting people who recognize the importance of privacy, we would like to provide a forum where this community can grow.
{%- endtrans}
...
{%- endtrans %}
{% trans -%}
I2PCon is entirely free to attend!
We ask you to register `here <http://www.eventbrite.ca/e/i2p-meetup-tickets-17773984466>`_, to give us an estimate of how many people will be attending. No identifying information has to be given in order to register, but if you have any concerns, please let us know.
{%- endtrans %}
...
{%- endtrans %}
{% trans -%}
`Hacklab <https://hacklab.to/>`_ at 1266 Queen Street West, Unti #6, Toronto.
{%- endtrans %}
...
{%- endtrans %}
{% trans -%}
Power and WiFi access will be provided by `Hacklab <https://hacklab.to/>`_.
{%- endtrans %}
